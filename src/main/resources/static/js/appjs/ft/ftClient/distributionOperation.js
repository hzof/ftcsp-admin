...
//=========跳转到分配操作人员绑定的函数============
function distributionOperation(id){
	layer.open({
		type : 2,
		title : '分配操作人员',
		maxmin : true,
		...
		area : [ '800px', '520px' ],
		content : prefix + '/distributionOperation/'+id // iframe的url
	});
}
//=======下面的代码自动生成======
$(function() {
						...
						columns : [
								{
									...
									align : 'center',
									formatter : function(value, row, index) {
										var f = '<a class="btn btn-success btn-sm" href="#" title="分配操作人员"  mce_href="#" onclick="distributionOperation(\''
												+ row.ftClientId
