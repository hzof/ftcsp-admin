			...
			.bootstrapTable(
					{
						...
						url : prefix + "/contractSuperviseList", // 服务器数据的加载地址
					//	showRefresh : true,
					//	showToggle : true,
					//	showColumns : true,
						iconSize : 'outline',
...
function edit(id) {
	layer.open({
		...
		shadeClose : false, // 点击遮罩关闭层
		area : [ '800px', '520px' ],
		content : prefix + '/editContract/' + id // iframe的url
	});
}
function remove(id,contractState) {
