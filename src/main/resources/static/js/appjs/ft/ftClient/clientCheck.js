						...
						columns : [
								{
									...
									formatter : function(value, row, index) {
										...
										var f = '<a class="btn btn-success btn-sm" href="#" title="审核资质"  mce_href="#" onclick="companyAudit(\''
												+ row.ftClientId
...
/**
 * 营销部经理对资质审核中的客户进行资质审核
 * @param id
 * @returns
 */
function companyAudit(id) {
	layer.open({
		type : 2,
		title : '资质审核',
		maxmin : true,
		shadeClose : false, // 点击遮罩关闭层
		area : [ '800px', '520px' ],
		content : prefix + '/companyAudit/' + id // iframe的url
	});
}
